...
//                       : ""
//                   } nav-link`}
//                   to="/dashboard/special-pages/Customer"
//                 >
//                   <i className="icon">
//                     <svg
//                       xmlns="http://www.w3.org/2000/svg"
...
//                       : ""
//                   } nav-link`}
//                   to="/dashboard/special-pages/viewcustomer"
//                 >
//                   <i className="icon">
//                     <svg
//                       xmlns="http://www.w3.org/2000/svg"
      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu" width='20px'>
        ...
        >
          ...
          <Accordion.Collapse eventKey="sidebar-configuration">
            <ul className="sub-nav">
              {/* Add sub-menu items for Configuration here */}
              <li className="nav-item">
                <Link
                  className={`${
                    location.pathname === "/dashboard/special-pages/billing"
              ...
              <li className="nav-item">
                ...
                >
                  ...
                  <i className="sidenav-mini-icon">View</i>
                  <span className="item-name">View Configuration</span>
                </Link>
              </li>
